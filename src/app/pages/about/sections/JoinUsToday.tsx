...
export const JoinUsToday = () => {
  ...
  return (
    <section
      ...
      className="join-us-today-section relative h-auto w-full max-w-[1920px] mx-auto flex items-center bg-warning-300"
    >
      <Image
        priority
        width={1000}
        height={100}
        alt="join-us-today background image"
        src="stylish-scandinavian-living-room-with-design-mint-sofa-furnitures-mock-up-poster-map-plants-eleg.jpg"
        className="absolute inset-0 h-full w-full object-cover"
      />
      <section
        id="join-us-today-overlap-section"
        className="join-us-today-overlap-section relative h-auto w-full max-w-[1920px] mx-auto px-8 py-8 md:py-24 flex items-center backdrop-blur-md bg-white/50"
      >
