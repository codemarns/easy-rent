...
export const Resorts = () => {
  ...
  const rental_offers = [
    {
      ...
      description: `Sink your toes into the sand and enjoy the sound of the waves in our beachfront resort properties. Relax in tropical luxury.`,
    },
    {
      id: "mountain-hideaways",
      name: "Mountain Hideaways",
      description: `For a peaceful and secluded escape, our mountain resort properties provide a tranquil retreat surrounded by nature.`,
    },
    {
      id: "island-resorts",
      name: "Island Resorts",
      description: `Explore the beauty of island living with our island resorts. These properties often feature private beaches and stunning ocean views.`,
    },
    {
      id: "island-resorts",
      name: "Island Resorts",
  ...
  return (
    <section
      id="resorts-section"
      className="resorts-section relative h-auto w-full max-w-[1920px] mx-auto px-8 py-24 flex items-center"
    >
