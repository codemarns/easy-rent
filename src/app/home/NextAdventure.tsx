...
export const NextAdventure = () => {
  ...
  return (
    ...
    >
      ...
      />
      <section
        id="next-adventure-overlap-section"
        className="next-adventure-overlap-section relative h-auto w-full max-w-[1920px] mx-auto px-8 py-8 md:py-24 flex items-center backdrop-blur-md bg-white/50"
      >
        <div className="relative h-auto w-full max-w-[1440px] mx-auto space-y-24 flex flex-col items-center">
          ...
          <div className="space-y-12 text-center">
            <p className="relative block max-w-[900px] text-2xl leading-normal text-center font-semibold">
              Ready to embark on your next vacation or business trip? Explore
              our selection of rental properties, and start planning your next
